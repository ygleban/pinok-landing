...
const steps: Array<{ num: string; title: string; desc: ReactNode }> = [
  ...
  },
  {
    ...
    desc: "Включите нужные модули (закупки, отзывы, бронирования и тд), создайте чек-листы, задайте правила маршрутизации: кто создаёт и кто получает.",
  },
  {
    num: "05",
    title: "Управление и контроль",
    desc: "Сотрудники работают в Telegram, руководитель видит всё в веб-кабинете: загрузку команды, выполнение чек-листов, статистику отзывов.",
  },
];
