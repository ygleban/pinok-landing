...
const steps: Array<{ num: string; title: string; desc: ReactNode }> = [
  ...
  },
  {
    ...
    desc: "Задайте подразделения (кухня, зал, бар) и должности (повар, официант, бариста). Для каждой должности настройте права доступа к модулям и матрицу ответственности — кто за кого отвечает в задачах, чек-листах, согласованиях.",
  },
  {
    num: "03",
...
const modules: Module[] = [
  ...
  },
  {
    ...
    features: [
      ...
      "Согласование смен руководителем",
  ...
  },
  {
    icon: ShoppingCart,
    title: "Закупки",
    desc: "Заявки на закупку расходных материалов, продуктов, инструментария от сотрудников и согласование руководителем.",
    features: [
  ...
  },
  {
    ...
    features: [
      "Несколько списков для разных зон: бар, кухня, общий",
      "Несколько типов позиций внутри списка (закончилось, временно недоступно)",
...
const securityItems: SecurityItem[] = [
  {
    ...
    desc: "Все данные передаются и хранятся в зашифрованном виде.",
  },
  {
    icon: ShieldCheck,
  ...
  },
  {
    ...
    desc: "На административных учётных записях.",
  },
  {
    icon: Server,
